...
confirmClearBtn.onclick = () => {
    ...
    confirmClearBtn.textContent = "Limpando...";
    ...
    xhr.onload = () => {
        if(xhr.readyState === XMLHttpRequest.DONE){
            ...
            confirmClearBtn.textContent = "Limpar";
            clearChatModal.classList.remove("active");
            if(xhr.status === 200 && xhr.response.trim() === "success"){
                chatBox.innerHTML = '<div class="text">Nenhuma mensagem ainda. Diga olá! 👋</div>';
            }
        }
    }
